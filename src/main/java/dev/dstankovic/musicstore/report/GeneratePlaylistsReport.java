...
public class GeneratePlaylistsReport {

    private static final Logger logger = LoggerFactory.getLogger(GeneratePlaylistsReport.class);

    public static ByteArrayInputStream playlistsReport(List<Playlist> playlists) {
        ...
        try {
            ...
            cell = new PdfPCell(new Phrase("Playlists", font));
            cell.setPadding(10);
            ...
            for (Playlist playlist : playlists) {
                ...
                cell = new PdfPCell(new Phrase(playlist.getName()));
